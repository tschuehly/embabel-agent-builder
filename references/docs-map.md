...
```text
github.com/embabel/embabel-agent/tree/<ref>/embabel-agent-docs/src/main/asciidoc
```

Raw file pattern:

```text
raw.githubusercontent.com/embabel/embabel-agent/<ref>/embabel-agent-docs/src/main/asciidoc/<path>
```
